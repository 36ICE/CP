	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			if(roleService.isRole(userNum, ConstantValue.ROLE_TEACHER) ){
				...
				System.out.println("showTarListServlet,jsArr"+jsArr);
				
				req.setAttribute("content", ConstantValue.RoleTeacher.PAGE_TEACHER_updateSTUDENTLIST);
				...
				req.getRequestDispatcher(ConstantValue.RoleAdmin.PAGE_TEMPLETE_INDEX_JSP).forward(req, resp);
