...
<%
       ...
       //ArrayList<TUser> alist=new ArrayList<TUser>();
      // alist.add(user);
      // alist.add(user);
    	//System.out.println(beanToMap(user).toString());
    	//JSONObject jsObj = JSONObject.fromObject(user);
    	
    	//JSONArray jsArr=JSONArray.fromObject(user);
...
<script type="text/javascript">
  var $table = $('#table'), $remove = $('#re_send_selected');
    ...
    });*/  window.location.href="ShowSelAssServlet?content=tshowselass.jsp&paruserNum="+eval(row).userNum;
 }
};
